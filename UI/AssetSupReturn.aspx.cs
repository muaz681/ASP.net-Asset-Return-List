...
namespace UI.Asset
{
    public partial class AssetSupReturn : System.Web.UI.Page
    {
        ...
        private void assetData()
        {
            ...
            dt = bll.GetAssetDataTable(3, 0, actionBy, 0, 0, 0, ToString());
        ...
        protected void apprvBtnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = bll.GetAssetDataTable(4, srid, actionBy, 0, 0, 0, ToString());
                assetData();
            }
            catch
            {
        ...
        protected void rejectBtnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = bll.GetAssetDataTable(5, srid, actionBy, 0, 0, 0, textLabel);
                assetData();
            }
            catch
            {
