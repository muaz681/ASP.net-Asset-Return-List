...
namespace UI.Asset
{
    public partial class AssetITStore : System.Web.UI.Page
    {
        ...
        {
            dt = bll.GetAssetDataTable(12, 0, 0, 0, 0, 0, ToString());
        ...
        protected void apprvBtnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = bll.GetAssetDataTable(13, srid, actionBy, 0, 0, 0, ToString());
                assetData();
            }
            catch
            {
