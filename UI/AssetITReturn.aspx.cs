...
namespace UI.Asset
{
    public partial class AssetITReturn : System.Web.UI.Page
    {
        ...
        {
            dt = bll.GetAssetDataTable(9, 0, 0, 0, 0, 0, ToString());
        ...
        protected void apprvBtnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = bll.GetAssetDataTable(10, srid, actionBy, 0, 0, 0, ToString());
                assetData();
            }
            catch
            {
        ...
        protected void rejectBtnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = bll.GetAssetDataTable(11, srid, actionBy, 0, 0, 0, textLabel);
                assetData();
            }
            catch
            {
